...
![table-tail.png](images/table-tail.png)
...
![table-describe.png](images/table-describe.png)
...
![table-describe-2.png](images/table-describe-2.png)
...
![table-groupby-doctors.png](images/table-groupby-doctors.png)

```python
df.groupby(by =['class', 'doctor_name']).count()
```

![table-groupby-class.png](images/table-groupby-class.png)

```python
df.groupby(by =['bare_nuclei', 'class']).count()
```

![table-groupby-barei.png](images/table-groupby-barei.png)
